🏆 Тулза для локалізації досягнень Steam від Вени

🎮 Steam Achievement Localizer — це настільний застосунок на Python + PyQt6, який дозволяє переглядати, експортувати, перекладати й замінювати досягнення у .bin файлах Steam.
