...
Хочете створити власні теми для застосунку? Перегляньте наші детальні посібники:

- **📖 [Посібник зі створення тем (Українська)](contribution/THEMES_UA.md)** - Повна інструкція українською мовою
- **📖 [Theme Creation Guide (English)](contribution/THEMES.md)** - Complete instructions in English

Дізнайтеся як:
- Створювати JSON файли тем із власними кольорами та стилями
- Налаштовувати порядок тем в інтерфейсі  
- Додавати локалізацію для назв тем
- Ділитися своїми темами зі спільнотою
